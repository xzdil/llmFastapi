...
RUSSIAN_TEXT_TO_SQL_TMPL = (
    ...
    "описания, не забудь указать колонны в кавычки."
    "Будьте осторожны и не запрашивайте несуществующие столбцы, не забудь указать колонны в кавычки."
    "Обратите внимание, какой столбец в какой таблице находится, не забудь указать колонны в кавычки."
    "Также,при необходимости уточняйте имена столбцов именем таблицы, не забудь указать колонны в кавычки."
